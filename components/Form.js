...
const Form = () => {
    ...
    const validtion = () => {
        ...
        if (userDetails.fname.trim() === "") {
            msgError.innerHTML = "<li>First name is required</li>";
            isValid = false;
        } else {
            msgError.innerHTML = "";
        ...
        if (userDetails.lname.trim() === "") {
            msgError1.innerHTML = "<li>Last name is required</li>";
            isValid = false;
        } else {
            msgError1.innerHTML = ""
        }
        ...
        if (userDetails.country === "") {
            msgError2.innerHTML = "<li>Country is required</li>";
            isValid = false;
        } else {
            msgError2.innerHTML = ""
        }
        ...
        if (userDetails.language === "") {
            msgError3.innerHTML = " <li>Language is required</li>";
            isValid = false;
        } else {
            msgError3.innerHTML = ""
        }
        ...
        if (userDetails.vehicle.length === 0) {
            msgError4.innerHTML = "<li>At least one vehicle is required</li>";
            isValid = false;
        } else {
            msgError4.innerHTML = ""
        }
        ...
        <div>
            <form action="#" onsubmit="return validtion()">
                ...
                <div className="container-fluid">
                    ...
                    <input type="text" id="fname" onChange={(e) => handleChange(e)} value={userDetails.fname} name="fname" placeholder="Your name.." class="form-control" /><br></br>
                    <div>
                        <span id='firstname'></span>
                    </div>

                    <label for="lname">Last Name</label>
                    <input type="text" id="lname" onChange={(e) => handleChange(e)} value={userDetails.lname} name="lname" placeholder="Your last name.." class="form-control" /><br></br>
                    <div>
                    ...
                    <label>Please select your favorite Web language:</label><br></br>
                    ...
                    <label>Please select your Vehicle:</label><br></br>
